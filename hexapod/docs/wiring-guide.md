...
**方案一：免焊面包板（推荐先用这个跑通）**。XIAO（焊好排针）插在 170 孔迷你面包板中间，面包板两侧的孔当 3V3 和 GND 母线；PCA9685、BNO085、电压检测模块、雷达、OLED、功放都用**杜邦线**连到对应的孔。唯一要焊的是 1N5819：直接焊在 5V_SV 线和一根到 XIAO 5V 的杜邦线之间，套热缩管。走路会震，跑通以后在杜邦线接头上点一点热熔胶。
