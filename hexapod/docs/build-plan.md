...
| 电池检测 | **0–25 V 电压检测模块** | 现成分压小板，免得自己搭电阻 |
| 连接 | **170 孔面包板 + 杜邦线**（免焊），跑通后可换洞洞板 | 只有电源线和 1 个二极管需要焊 |
...
| 类别 | 约 |
|---|---|
| 电子模块（A2–A6，主控已有） | ¥380–600 |
| 电源（B1–B9，含 2 块电池和充电器） | ¥165–365 |
| 连接线材（C1、C3–C5、C7） | ¥25–40 |
| 结构件（D1–D8） | ¥50–135 |
| **合计（不含已有主控、可选项、电脑、工具）** | **约 ¥620–1130** |
| 可选：OLED、功放、灯条、摄像头板等 | + ¥70–190 |
