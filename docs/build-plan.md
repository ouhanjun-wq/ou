...
| E3 | USB-C 数据线 | USB-A 转 USB-C，1.5–2 m，**能传数据**（不是只能充电的线） | 1 | G7 Pro 接扩展板 | `USB-A转Type-C 数据线 2米` | 10 |
...
如果手边已经有 Uno、洞洞板、杜邦线、万用表这些常用件，实际花费更少。
...
- [ ] 按 1.2–1.4 节下单（套件和手柄已经有了）。套件按 1.1 节的清单点一遍零件。
